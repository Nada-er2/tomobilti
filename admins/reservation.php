...
$stmt = $conn->query("SELECT Reservations.*, locataire.nom, locataire.prenom FROM Reservations JOIN locataire ON locataire.num_locataire = Reservations.id_client");
            ...
            <tbody>
                <?php foreach ($reservations as $reservation): ?>
                    <tr>
                        ...
                        <td>
                            <a href="supprimerreservation.php?idreservation=<?= htmlspecialchars($reservation['id_reservation']) ?>" 
